...
// func downloadPDFFile(service *drive.Service, file *drive.File) ([]byte, error) {
...
// 		content, err := downloadPDFFile(srv, latestPDF)
// 		if err != nil {
// 			return c.String(http.StatusInternalServerError, fmt.Sprintf("Unable to download PDF file: %v", err))
// 		}

// 		// Set response headers
// 		c.Response().Header().Set(echo.HeaderContentType, "application/pdf")
// 		c.Response().Header().Set(echo.HeaderContentDisposition, "attachment; filename="+latestPDF.Name)
